...
public class AnalogStick extends Element{
    ...
    private List<AnalogStick.AnalogStickListener> listeners = new ArrayList<>();
    ...
    public AnalogStick(ElementController controller, ElementBean elementBean, Context context) {
    ...
    public void addAnalogStickListener(AnalogStick.AnalogStickListener listener) {
    ...
    private void notifyOnMovement(float x, float y) {
        ...
        // notify listeners
        for (AnalogStick.AnalogStickListener listener : listeners) {
